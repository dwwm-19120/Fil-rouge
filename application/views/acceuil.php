...
<!-------------------------------------------MEILLEURES VENTES----------------------------------------------------------->
    ...
    <div class="row">
        <figure class="col-2 ml-sm-4 p-0">
            <a class="ventes-link" href="/">
                <img src="<?php echo base_url('assets/img/TOP_VENTES_guitare.png');?>" title="top guitare" alt="">
            </a>
        </figure>
        <figure class="col-2 ml-sm-1 p-0">
            <a class="ventes-link" href="/">
                <img src="<?= base_url('assets/img/TOP_VENTES_saxo.png')?>" title="top saxo" alt="">
            </a>
        </figure>

        <figure class="col-2 p-0">
            <a class="ventes-link" href="/">
                <img src="<?= base_url('assets/img/TOP_VENTES_piano.png');?>" title="top piano" alt="">
            </a>
        </figure>
        <figure class="col-6 p-0">
            <a class="partenaires-link" href="/">
                <img src="<?= base_url('assets/img/partenaires_4_logos.png');?>" title="nos partenaires" alt="partenaires" ref="nofollow">
            </a>
        </figure>
    </div>
<!----------------------------------------------------------NOS PARTENAIRES----------------------------------------------------->
