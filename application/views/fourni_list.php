...
<?php
        foreach($fournisseur as $fourni)
        {
            ?>
                <tr>
                    <td><a href="<?= site_url('fournisseurs/fourniMaj/'.$fourni->fourni_id);?>"><button><i class="fas fa-pencil-alt"></i></button></a><a href="<?= site_url('fournisseurs/suppressionamettre/'.$fourni->fourni_id);?>"><button><i class="fas fa-trash-alt"></i></button></a></td>
