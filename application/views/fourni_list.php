...
if(empty($fournisseur))
{
    ...
    <h1>tableaux vide</h1>
    <p>pour le remplir</p>
   <a href="<?= site_url('fournisseurs/fourniAj');?>"><button><i class="fas fa-pencil-alt"></i></button></a>
...
<?php
        foreach($fournisseur as $fourni)
        {
            ?>
                <tr>
                    <td><a href="<?= site_url('fournisseurs/modifamettreici/'.$fourni->fourni_id);?>"><button><i class="fas fa-pencil-alt"></i></button></a><a href="<?= site_url('fournisseurs/suppressionamettre/'.$fourni->fourni_id);?>"><button><i class="fas fa-trash-alt"></i></button></a></td>
