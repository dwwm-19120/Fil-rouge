...
<!--titre-->
    <div class="text-center">
        ...
        <h1>bienvenue <?=$_SESSION['info']?> sur l'espace administrateur </h1>
    </div>
<!--bouton deconnexion et retour a la partie visible du site-->
    <div class="ml-auto mr-auto">
            <a href="<?= site_url('administration/maj_personnel');?>" title="votre compte" class="btn btn-outline-dark"><i class="fas fa-user"></i></a>  
